...
function Home() {
    ...
    useEffect(() => {
        ...
        const fetchUserWorkouts = async () => {
            try {
                const response = await fetch(`http://52.41.36.82:3001/getWorkouts/${username}`);
                if (response.ok) {
        ...
        const fetchSharedExcercises = async () => {
            if (selectedSharedWorkoutIndex !== null) {
                try {
                    ...
                    const response = await fetch(`http://52.41.36.82:3001/getSharedExercises/${username}/${selectedSharedWorkoutIndex}/${selectedDay}`);
                    if (response.ok) {
                        const data = await response.json();
    ...
    useEffect(() => {
        const fetchUserExercises = async () => {
            try {
                const response = await fetch(`http://52.41.36.82:3001/getExercises/${username}/${selectedWorkoutIndex}/${selectedDay}`);
                if (response.ok) {
                    const data = await response.json();
                    setExercises(data.exercises || []);
                } else {
    ...
    useEffect(() => {
        const fetchUserSharedWorkouts = async () => {
            try {
                const response = await fetch(`http://52.41.36.82:3001/getSharedWorkouts/${username}`);
                if (response.ok) {
                    const data = await response.json();
    ...
    const handleCreateSubmit = async () => {
        try {
            const response = await fetch("http://52.41.36.82:3001/addWorkout", {
                method: "POST",
                headers: {
    ...
    const handleEditSubmit = async () => {
        try {
            const response = await fetch("http://52.41.36.82:3001/updateWorkoutName", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    const handleDelete = async (index) => {
        try {
            const response = await fetch("http://52.41.36.82:3001/deleteWorkout", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    const moveToWorkouts = async (index) => {
        try {
            const response = await fetch(`http://52.41.36.82:3001/moveToWorkouts/${username}/${index}`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    const handleExerciseSubmit = async () => {
        try {
            ...
            const response = await fetch("http://52.41.36.82:3001/addExercise", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    const handleShare = async (index) => {
        ...
        if (shareUsername) {
            try {
                const response = await fetch(`http://52.41.36.82:3001/shareWorkout/${shareUsername}`, {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json",
                    },
    ...
    const handleDeleteExercise = async (index) => {
        try {
            const response = await fetch("http://52.41.36.82:3001/deleteExercise", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    const handleUpdateExercise = async (index) => {
        try {
            ...
            const response = await fetch("http://52.41.36.82:3001/updateExercise", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
